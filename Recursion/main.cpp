...
int main(void) {
	...
	/* test sqrt */
	printf("the sqrt of 25 is %.15g\n", sqrtIt(10.0, 0, 145.0));
	printf("the sqrt of 26 is %.15g\n", sqrtIt(26.0, 0, 26.0));
	printf("the sqrt of 2 is %.15g\n", sqrtIt(2.0, 0, 2.0));
	printf("the sqrt of 25 is %.15g\n", sqrtRec(10.0, 0, 25.0));
	printf("the sqrt of 26 is %.15g\n", sqrtRec(26.0, 0, 26.0));
	printf("the sqrt of 2 is %.15g\n", sqrtRec(2.0, 0, 2.0));
...
//	Martian change10 = change(72);
//	printf("change 5 should be 6d, 0n, 0p and is: %dd %dn %dp\n", change10.dodeks, change10.nicks, change10.pennies);
//
//	Martian change11 = change(57);
//	printf("change 6 should be 3d, 4n, 1p and is: %dd %dn %dp\n", change11.dodeks, change11.nicks, change11.pennies);
//
//	Martian change12 = change(12);
//	printf("change 7 should be 1d, 0n, 0p and is: %dd %dn %dp\n", change12.dodeks, change12.nicks, change12.pennies);
	...
	printf("change 8 should be 2d, 0n, 1p and is: %dd %dn %dp\n", change4.dodeks, change4.nicks, change4.pennies);

//	change10 = change(72, 5, 12);
//	printf("change 10 should be 6d, 0n, 0p and is: %dd %dn %dp\n", change10.dodeks, change10.nicks, change10.pennies);


	printf("Test Martian Iterative\n");
		Martian change5 = changeIt(15);
		printf("change 1 should be 0d, 3n, 0p and is: %dd %dn %dp\n", change5.dodeks, change5.nicks, change5.pennies);

		Martian change6 = changeIt(0);
		printf("change 2 should be 0d, 0n, 0p and is: %dd %dn %dp\n", change6.dodeks, change6.nicks, change6.pennies);

		Martian change7 = changeIt(17);
		printf("change 3 should be 1d, 1n, 0p and is: %dd %dn %dp\n", change7.dodeks, change7.nicks, change7.pennies);

		Martian change8 = changeIt(25);
