/*** Spell Checker Program written by Kevin Yee to demonstrate knowledge of pointers/data structures in C/C++ ***/
...
void spellCheck(std::string, std::string); // this is the function you write (put your function in Project1.cpp
